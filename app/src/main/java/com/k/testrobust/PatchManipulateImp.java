...
public class PatchManipulateImp extends PatchManipulate {
	...
	protected List<Patch> fetchPatchList(Context context) {
		...
		patch.setLocalPath(Environment.getExternalStorageDirectory().getPath() + File.separator + "patch");
		...
		//请注意这里的设置
		patch.setPatchesInfoImplClassFullName("com.k.testrobust.PatchesInfoImpl");
